...
Nova.booting(function (Vue, router) {
    Vue.component('index-map_address', __webpack_require__(3));
    Vue.component('detail-map_address', __webpack_require__(6));
    Vue.component('form-map_address', __webpack_require__(9));
});
